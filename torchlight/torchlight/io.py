...
class IO():
    def __init__(self, work_dir, session, save_log=True, print_log=True):
    ...
    def save_model(self, state, name):
        ...
        self.print_log('The model has been saved as {}.'.format(name))

    def save_arg(self, arg):

        self.session_file = '{}/config/config_{}.yaml'.format(self.work_dir, self.session)
    ...
    def print_log(self, str, print_time=True):
        ...
        if self.print_to_screen:
            print(str)
        if self.save_log:
            with open('{}/log/log_{}.txt'.format(self.work_dir, self.session), 'a') as f:
                print(str, file=f)
